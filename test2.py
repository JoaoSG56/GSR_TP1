...
import json
import secrets
#f = Fernet(json.load(open('key.json'))["key"])


f = (secrets.token_bytes())
#data = b'Teste|assim$LOL;okla'
data = 'Teste|assim$LOL;okla'

encrypted_data = cryptocode.encrypt(data,"password123")
print(encrypted_data.encode('latin-1'))

print()
print()

decrypted_data = cryptocode.decrypt(encrypted_data,"password123")
